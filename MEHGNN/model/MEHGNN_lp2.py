...
class MEHGNN_lp2(nn.Module):
    def __init__(self,
                 ...
                 rnn_type='gru',
                 dropout_rate=0.5):
        super(MEHGNN_lp2, self).__init__()
    ...
    def forward(self, inputs,kg,denoised_kg):
        ...
        entity_embeddings = self.rgat(self.entity_emb, self.relation_emb, kg) + self.rgat(self.entity_emb, self.relation_emb, denoised_kg)
